...
from ...resources.strings import SALES_DOES_NOT_EXIST_ERROR, STOCK_DOES_NOT_EXIST_ERROR, SELLER_DOES_NOT_EXIST_ERROR, \
    BUYER_DOES_NOT_EXIST_ERROR, CAR_DOES_NOT_EXIST_ERROR
